...
void DataAggregator::print_header() {
    cout << "------------------------------------------------\n";
}

void DataAggregator::print_daily_stock_info(string ticker, float percent_gained, int winning_picks, int losing_picks, int days_selling_after_buying) {
    cout << "STOCK: " << ticker << "\n";
...
void DataAggregator::print_yearly_stock_info(string ticker, float percent_gained,int winning_picks,
